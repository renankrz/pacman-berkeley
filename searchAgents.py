...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        return len(corners) == 1 and corners[0] == position
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                nextCorners = tuple(
                    filter(lambda p: p != position, corners))
...
def cornersHeuristic(state, problem):
    ...
    while len(corners) != 0:
        ...
        corners = tuple(filter(lambda c: c != closestCorner, corners))
...
class LRTAStarCornersAgent(SearchAgent):
    ...
    def __init__(self):
        self.searchFunction = lambda prob: search.learningRealTimeAStar(
            prob, cornersHeuristic)
        self.searchType = CornersProblem
